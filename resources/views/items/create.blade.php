                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <form method="POST" action="{{ route('items.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <input id="purchase_time" type="datetime-local" name="purchase_time" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm block mt-1 w-full" value="{{ old('purchase_time') }}" />
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="location" list="location-list" class="block mt-1 w-full" type="text" name="location" :value="old('location')" placeholder="Ketik atau pilih lokasi..." />
